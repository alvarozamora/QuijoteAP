...
result_dir = f'results_{snap}_dir/'
...
for q, sim in enumerate(sims):
    ...
    for s in S:
        if cont and check:
            ...
            pp, z, _ = PZD(sdata, squery, noRSD, noRSDids, avg=False,bs=sbs,verb=True)
            ...
            zp, zz, _ = PZD(szdata, squery, RSD, RSDids, avg=False, bs=sbs, verb=True)
