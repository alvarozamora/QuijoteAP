...
if yt.is_root():
    ...
    plt.savefig("DirectionalParamScan_numberdensity_KS_OmpStretch.png",dpi=230)
    ...
    plt.savefig("DirectionalParamScan_scale_KS_OmpStretch.png",dpi=230)
    ...
    plt.ylabel("a(z=0.5)")
    plt.title("Quijote Varying Number Density")
    plt.savefig("DirectionalParamScan_numberdensityz_KS_OmpStretch.png",dpi=230)
    ...
    plt.ylabel("a(z=0.5)")
    plt.title("Quijote Varying Distance Scale")
    plt.savefig("DirectionalParamScan_scalez_KS_OmpStretch.png",dpi=230)
    ...
    yerr = zstds[ndist]
    labels = labels
    np.savez('QPS_fiducial_KS_OmpStretch',x=x,y=y,yerr=yerr,labels=labels, nzstds=nzstds[ndist])
