...
# Specify Stretches
S = [1.00, 1.01, 1.02, 0.98]

# Specify Output Directory
result_dir = f'results_{snap}_square/'
...
for q, sim in enumerate(sims):
    ...
    for s in S:
        if cont and check:
            ...
            pp, z = SquarePyramid(sdata, squery, noRSD, noRSDids, k=squarek, bs=sbs,verb=True)
            ...
            zp, zz = SquarePyramid(szdata, squery, RSD, RSDids, k=squarek, bs=sbs, verb=True)
