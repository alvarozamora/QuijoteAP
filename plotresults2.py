...
avg, zavg, c2s, zc2s = extract_results(c2=True)#results)
...
c2stdev =  c2s.std(0)/np.sqrt(len(c2s))
c2ztdev = zc2s.std(0)/np.sqrt(len(zc2s))
cumulants  =  c2s.mean(0)
zcumulants = zc2s.mean(0)
